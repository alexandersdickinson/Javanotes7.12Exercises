...
public class ChatRoomWindow extends JFrame {
    ...
    private class ChatClient extends Client {
        ...
        protected void messageReceived(Object message) {
            if (message instanceof ForwardedMessage) {  // (no other message types are expected)
				...
				if(bm.message instanceof ChatMessage){
					ChatMessage messageData = (ChatMessage)bm.message;
               		addToTranscript("#" + messageData.getName() + " SAYS:  " + messageData.getMessage());
				}
            }
        }
	...
	/**
		This class bundles a string with the ChatClient's name. This allows other clients to see the name of the people they are communicating with. This is
		the object sent with send() subroutine.
	*/
